...
const useStyles = createUseStyles({
  ...
  cls2:{fill:'url(#animated-linear-gradient)', fillRule:'evenodd'},
  cls3:{fill:'url(#animated-linear-gradient-2)', fillRule:'evenodd'},
  cls4:{fill:'url(#animated-linear-gradient-3)', fillRule:'evenodd'},
  cls5:{fill:'url(#animated-linear-gradient-4)', fillRule:'evenodd'},
  cls6:{stroke:'#ececec',strokeWidth:0.71, fill:'#fff'},
  cls7:{fill:'#9da9b7'},
  cls8:{fill:'url(#animated-linear-gradient-5)', fillRule:'evenodd'},
  cls9:{fill:'url(#animated-linear-gradient-6)', fillRule:'evenodd'},
      ...
      viewBox="0 0 671.91 354.96">
        <defs>
            <linearGradient id="animated-linear-gradient" x1="339.47" y1="-210.84" x2="339.47" y2="-210.31" gradientTransform="translate(-50556.45 -11697.06) rotate(45.11) scale(130.71 130.71)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#49b750"/>
                <stop offset="1" stop-color="#15a74a"/>
            </linearGradient>
            <linearGradient id="animated-linear-gradient-2" x1="338.98" y1="-210.36" x2="338.98" y2="-209.85" gradientTransform="translate(-50559.3 -11684.87) rotate(45.09) scale(130.71 130.71)" xlinkHref="#animated-linear-gradient"/>
            <linearGradient id="animated-linear-gradient-3" x1="341.11" y1="-212.49" x2="341.11" y2="-211.96" xlinkHref="#animated-linear-gradient"/>
            <linearGradient id="animated-linear-gradient-4" x1="340.62" y1="-212" x2="340.62" y2="-211.5" gradientTransform="translate(-50559.3 -11684.87) rotate(45.09) scale(130.71 130.71)" xlinkHref="#animated-linear-gradient"/>
            <linearGradient id="animated-linear-gradient-5" x1="340.95" y1="-210.71" x2="340.95" y2="-210.18" gradientTransform="translate(-11786.47 51077.88) rotate(-44.89) scale(130.71 130.71)" xlinkHref="#animated-linear-gradient"/>
            <linearGradient id="animated-linear-gradient-6" x1="340.46" y1="-210.23" x2="340.46" y2="-209.72" gradientTransform="translate(-11774.29 51080.74) rotate(-44.91) scale(130.71 130.71)" xlinkHref="#animated-linear-gradient"/>
            <linearGradient id="animated-linear-gradient-7" x1="153.23" y1="37.12" x2="153.23" y2="38.12" gradientTransform="translate(-20929.5 -4917.98) scale(139)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f4f4f4" stop-opacity="0"/>
                <stop offset="1" stop-color="#f4f4f4"/>
            </linearGradient>
            <linearGradient id="animated-linear-gradient-8" x1="150" y1="33.37" x2="150" y2="34.37" gradientTransform="translate(-10131 -929.16) scale(70 36.59)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#0fcc4f"/>
        ...
        <g id="animated-cable-left">
            <g id="animatedmalecable">
                ...
                <path className={classes.cls2} d="M225.31,317.79a1.4,1.4,0,0,1-1.7-1,1.34,1.34,0,0,1,0-.35v-.28h-5.4a2.08,2.08,0,0,1,0-4.16h5.4v-4.15l-5.39,0a2.07,2.07,0,1,1,0-4.13h5.38v-.3A1.41,1.41,0,0,1,225,302a1.24,1.24,0,0,1,.33,0l6.57,1.66h4.89a2,2,0,0,1,2.05,2.07V308l67.83.12a2,2,0,0,1,0,4h0l-67.83-.12,0,2.14a2.12,2.12,0,0,1-2.09,2.07" transform="translate(-32.04 -26.04)"/>
            </g>
            <g id="animatedfemalecable">
                <path id="path-2" className={classes.cls1} d="M210.76,303.39a1.32,1.32,0,0,1,0,.34l0,13.24a1.42,1.42,0,0,1-1.41,1.4,1.19,1.19,0,0,1-.33,0l-6.67-1.67H197.4a2.13,2.13,0,0,1-2.11-2.12l0-2.06-67.79-.1a2.15,2.15,0,0,1,0-4.3h0l67.79.1,0-2.06a2.11,2.11,0,0,1,2.11-2.09h5l6.66-1.66A1.4,1.4,0,0,1,210.76,303.39Z" transform="translate(-32.04 -26.04)"/>
        ...
        <g id="animated-cable-right">
            <g id="animatedmalecable-2" data-name="animatedmalecable">
                ...
                <path className={classes.cls4} d="M528.94,317.79a1.39,1.39,0,0,1-1.69-1,1.34,1.34,0,0,1,0-.35v-.28h-5.4a2.08,2.08,0,1,1,0-4.16h5.4v-4.15l-5.39,0a2.07,2.07,0,0,1,0-4.13h5.38v-.3a1.41,1.41,0,0,1,1.41-1.39,1.24,1.24,0,0,1,.33,0l6.57,1.66h4.89a2.05,2.05,0,0,1,2.06,2.07V308l67.83.12a2,2,0,0,1,0,4h0l-67.83-.12v2.14a2.11,2.11,0,0,1-2.08,2.07" transform="translate(-32.04 -26.04)"/>
            </g>
            <g id="animatedfemalecable-2" data-name="animatedfemalecable">
                <path id="path-2-3" data-name="path-2" className={classes.cls1} d="M514.39,303.39a1.32,1.32,0,0,1,0,.34l0,13.24a1.4,1.4,0,0,1-1.4,1.4,1.19,1.19,0,0,1-.33,0L506,316.66h-5a2.13,2.13,0,0,1-2.11-2.12l0-2.06-67.79-.1a2.15,2.15,0,0,1,0-4.3h0l67.79.1,0-2.06a2.1,2.1,0,0,1,2.1-2.09h5l6.66-1.66A1.4,1.4,0,0,1,514.39,303.39Z" transform="translate(-32.04 -26.04)"/>
        ...
        <g id="animated-cable-top">
            <g id="malecable-3" data-name="malecable">
                ...
                <path className={classes.cls8} d="M376.86,172a1.4,1.4,0,0,1-1,1.7,1,1,0,0,1-.35,0h-.28v5.4a2.08,2.08,0,0,1-4.16,0v-5.4h-4.15l0,5.39a2,2,0,0,1-2.06,2.06,2.07,2.07,0,0,1-2.07-2.08v-5.38h-.3a1.41,1.41,0,0,1-1.39-1.41,1.24,1.24,0,0,1,0-.33l1.66-6.57v-4.89a2,2,0,0,1,2.07-2.05H367l.12-67.83a2,2,0,1,1,4,0h0L371,158.47l2.14,0a2.1,2.1,0,0,1,2.07,2.08" transform="translate(-32.04 -26.04)"/>
            </g>
            <g id="animatedfemalecable-3" data-name="animatedfemalecable">
                <path id="path-2-5" data-name="path-2" className={classes.cls1} d="M362.46,186.55a1.32,1.32,0,0,1,.34,0l13.24,0a1.41,1.41,0,0,1,1.4,1.41,1.19,1.19,0,0,1,0,.33L375.73,195v4.95a2.12,2.12,0,0,1-2.11,2.11l-2.06,0-.1,67.79a2.16,2.16,0,0,1-2.16,2.15,2.13,2.13,0,0,1-2.14-2.14h0l.1-67.79-2.06,0a2.12,2.12,0,0,1-2.1-2.11v-5l-1.66-6.66A1.4,1.4,0,0,1,362.46,186.55Z" transform="translate(-32.04 -26.04)"/>
...
export default AnimatedPlugSvg;
